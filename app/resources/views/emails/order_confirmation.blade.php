...
<body style="margin:0;padding:0;background:#f4f7fb;font-family:Arial,sans-serif;color:#1f2937;">
    <div style="max-width:640px;margin:24px auto;background:#ffffff;border:1px solid #e5e7eb;border-radius:10px;overflow:hidden;">
        ...
        <div style="padding:20px;line-height:1.6;">
            ...
            <p style="margin:0 0 12px;">Hello {{ $customerName }}, your order has been successfully placed.</p>
            ...
            <table style="width:100%;border-collapse:collapse;">
                ...
                @endif
                @if($deliveryDate)
                <tr><td style="padding:8px;border-top:1px solid #e5e7eb;"><strong>Expected Delivery</strong></td><td style="padding:8px;border-top:1px solid #e5e7eb;">{{ $deliveryDate }}</td></tr>
                @endif
            </table>

            <div style="margin:20px 0;text-align:center;">
                <a href="{{ url('/') }}/orders/{{ $orderId }}" style="display:inline-block;background:#2563eb;color:#fff;padding:12px 24px;border-radius:6px;text-decoration:none;font-weight:bold;">Track Your Order</a>
            </div>
            
            <p style="margin:16px 0 0;font-size:14px;color:#6b7280;">You can also track status updates in the LaundryHub mobile app.</p>
        </div>
        ...
        <div style="border-top:1px solid #e5e7eb;padding:20px;background:#f9fafb;font-size:13px;color:#6b7280;">
            ...
            <p style="margin:0 0 12px;">If you have any questions about your order, please check your account settings or contact our support team.</p>
